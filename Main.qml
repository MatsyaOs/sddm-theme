...
Item {
    ...
    Image {
        id: wallpaperImage
        anchors.fill: parent
        source: "file://" + "/usr/share/backgrounds/matsyaos/default.jpg"
    ...
    Item {
        ...
        width: 260 + matsyaui.Units.largeSpacing * 3
        ...
        Rectangle {
            anchors.fill: parent
            radius: matsyaui.Theme.bigRadius + 2
            color: matsyaui.Theme.darkMode ? "#424242" : "white"
            opacity: 0.5
        }
        ...
        ColumnLayout {
            ...
            QQC2.TextField {
                ...
                background: Rectangle {
                    color: matsyaui.Theme.darkMode ? "#B6B6B6" : "white"
    ...
    Item {
        ...
        width: sessionMenu.implicitWidth + matsyaui.Units.largeSpacing
    ...
    Item {
        ...
        width: 50
        height: 50 + matsyaui.Units.largeSpacing
